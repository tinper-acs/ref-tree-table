...
class RefMultipleTableBaseUI extends Component {
	...
	render() {
        ...
        let { className, lang = 'zh_CN', valueField, showLoading, chosenText = '', hiddenChosenText = '', tableProps, mustPaginationShow, fieldid
        } = this.props;
		...
		return (
          ...
          hiddenChosenText={hiddenChosenText}
						...
						</RefCoreTab>
					{
						...
						<RefCoreError show={!Boolean(tableData.length)} language={lang} fieldid={fieldid ? fieldid : undefined} />
					} 
