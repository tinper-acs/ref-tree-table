...
import { Pagination, Checkbox, Table, Empty, Input } from '@tinper/next-ui'
...
class RefMultipleTableBaseUI extends Component {
  ...
  render() {
    ...
    let { className, lang = 'zh_CN', valueField, showLoading, placeholder = '', chosenText = '', hiddenChosenText = '', tableProps, mustPaginationShow
    } = this.props;
