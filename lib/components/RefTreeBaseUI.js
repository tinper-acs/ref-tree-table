  ...
  RefTreeBaseUI.prototype.render = function render() {
    ...
    return _react2["default"].createElement(
      ...
      this.treeData.length ? _react2["default"].createElement(_RefCoreTree2["default"], {
        ...
        checkStrictly: checkStrictly,
        showLine: showLine,
        loadData: lazyModal ? this.onLoadData.bind(this) : function () {}
      }) : _react2["default"].createElement(_RefCoreError2["default"], { show: !Boolean(this.treeData.length), language: lang })
    );
  };

  // @ts-ignore
  RefTreeBaseUI.prototype.__reactstandin__regenerateByEval = function __reactstandin__regenerateByEval(key, code) {
    // @ts-ignore
    this[key] = eval(code);
  };
...
(function () {
  ...
  reactHotLoader.register(noop, 'noop', '/Users/yaoxin/Downloads/workspace/aacanzhao/tinper-acs/ref-tree-table/src/components/RefTreeBaseUI.js');
  reactHotLoader.register(propTypes, 'propTypes', '/Users/yaoxin/Downloads/workspace/aacanzhao/tinper-acs/ref-tree-table/src/components/RefTreeBaseUI.js');
  reactHotLoader.register(defaultProps, 'defaultProps', '/Users/yaoxin/Downloads/workspace/aacanzhao/tinper-acs/ref-tree-table/src/components/RefTreeBaseUI.js');
  reactHotLoader.register(RefTreeBaseUI, 'RefTreeBaseUI', '/Users/yaoxin/Downloads/workspace/aacanzhao/tinper-acs/ref-tree-table/src/components/RefTreeBaseUI.js');
  reactHotLoader.register(_default, 'default', '/Users/yaoxin/Downloads/workspace/aacanzhao/tinper-acs/ref-tree-table/src/components/RefTreeBaseUI.js');
})();
